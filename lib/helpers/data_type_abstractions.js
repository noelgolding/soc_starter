...
class Config extends Object {
  /**
   * @param {string} [label = "config label"] useful for debugging.
  ...
  /**
   * An alias for {@link simplegameengine.config.Config#set set}
   * @function
   * @see {@link simplegameengine.config.Config#set set}
   * @param {string} name a case-insesitive property name
   * @param {*} value the new value to be stored
   */
  add = this.set
